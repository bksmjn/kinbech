...
<body>
	<div id="global">
		...
		<form:form modelAttribute="newProduct" action="${login_url}"
			method="POST">
			<form:errors path="title" class="errors" />
			<fieldset>
				<legend>Add New Product :</legend>
				Product Name :
				<form:input path="title" tabindex="1" />
				<br />
				...
				Quantity :
				<form:input path="quantityWhenUpload" tabindex="4" />
				<br />
				<form:errors path="unitPrice" class="errors" />
				Unit Price :
				<form:input path="unitPrice" tabindex="5" />
				<br />
